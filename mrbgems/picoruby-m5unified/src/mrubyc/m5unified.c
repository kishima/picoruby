...
void mrbc_m5unified_init(mrbc_vm *vm)
{
  ...
  // M5 class methods
  mrbc_define_method(vm, m5_class, "_begin", mrb_m5_begin);
  mrbc_define_method(vm, m5_class, "_update", mrb_m5_update);

  // Display class
  mrbc_class *display_class = mrbc_define_class_under(vm, m5_class, "Display", mrbc_class_object);
  mrbc_define_method(vm, display_class, "_clear", mrb_m5_display_clear);
  mrbc_define_method(vm, display_class, "set_text_size", mrb_m5_display_set_text_size);
